...
From terminal input (marks, attendance, study hours) predict PASS / FAIL with confidence percentage using Python ML model; Java handles user I/O and integration.
